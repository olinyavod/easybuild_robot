...
💾 Локальный путь: /home/repos/myapp
...
| **💾 Локальный путь** | Путь на сервере | `/home/repos/myapp` |
...
### Пример 2: Изменить несколько полей
