"""
.NET MAUI project builder implementation.
"""
...
class DotNetMauiBuilder(ProjectBuilder):
    """Builder for .NET MAUI projects."""
    
    async def prepare_environment(self) -> BuildResult:
        """Prepare .NET MAUI environment."""
    ...
    async def build_debug(self) -> BuildResult:
        ...
        try:
            ...
            # Usually in bin/Debug/net8.0-android/
    ...
    async def get_version_info(self) -> Optional[str]:
        ...
        try:
            ...
            with open(project_file, 'r', encoding='utf-8') as f:
                content = f.read()
                # Look for <ApplicationVersion> or <Version> tag
