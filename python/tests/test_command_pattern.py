...
from easybuild_bot.commands.implementations import StartCommand, HelpCommand
...
class TestCommand:
    ...
    def test_command_interface(self, mock_storage):
        ...
        command = StartCommand(mock_storage, "admin_token")
...
class TestCommandRegistry:
    ...
    def test_register_command(self, mock_storage):
        ...
        retrieved = registry.get_command("/start")
    ...
    def test_get_all_commands(self, mock_storage):
        ...
        cmd1 = StartCommand(mock_storage, "admin_token")
        cmd2 = HelpCommand(mock_storage, "admin_token")
    ...
    def test_match_command_semantic(self, mock_storage):
        ...
        match1 = registry.match_command("начать")
        match2 = registry.match_command("привет")
        match3 = registry.match_command("старт")
...
class TestCommandExecutor:
    ...
    async def test_match_and_execute(self, mock_storage, mock_update, mock_context):
        ...
        result = await executor.match_and_execute("привет", ctx)
